        ...
        <View style={{
            ...
            <View
                ...
                <View style={{ backgroundColor: 'white', bottom: height / 14, borderRadius: 100, borderColor: 'white', borderWidth: 5 }}>
                    <AntDesing name='exclamationcircle' size={60} color={'red'} />
                </View>

                <Text style={{ color: 'black', textAlign: 'center', top: -30 }}>
                    {msg}
                </Text>
                <TouchableOpacity style={{ backgroundColor: 'red', padding: 10, width: '75%', alignItems: 'center', borderRadius: 10 }} onPress={onPress}>
